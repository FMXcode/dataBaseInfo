    ...
    <div class="container" style="padding: 0 60px;">
        <div class="wapper_main" style="text-align: center;">
            ...
            <div class="line" style="background-color: black;
                                     height: 1px;
                                     margin-top: 3px;"></div>
            <p class="main_text" style="margin: 6px 0px;font-size: 12px">Федеральное государственное казенное военное образовательное учреждение высшего
            ...
            <p class="main_text field" style="margin: 6px 0px;
                                              font-size: 14px;">Доцент кафедры Военной академии связи, 12 кафедры (военных систем
            ...
            <p class="city" style="font-size: 18px;
                                   margin-top: 390px;">г. Санкт-Петербург</p>
        </div>
        <h2 style="text-align:center;font-size: 16px;
margin-top: 60px;">1. Общие сведения</h2>

        <div class="wapper_table" style="display:flex;
                                         justify-content:space-between;">
            <div class="wapper_img">
                <img src="../photo/Slice%202.png" alt="">
            </div>
            <div class="table">
        ...
        <h2 style="text-align:center;font-size: 16px;">3. Учебная работа</h2>
        <p>3.1. Преподаваемые дисциплины.</p>
        <div class="table" style="margin-top: 25px;">
            <table style="border: 1px solid #000;
                              border-collapse: collapse;
                              text-align:center;
        ...
        <p>3.2. Другие значимые достижения в области образовательной
            деятельности.</p>
        <div class="table" style="margin-top: 25px;">
            <table style="border: 1px solid #000;
                              border-collapse: collapse;
        ...
        <p>4.1. Публикации за последние 5 лет</p>
        <div class="table" style="margin-top: 25px;">
            <table style="border: 1px solid #000;
                              border-collapse: collapse;
                              text-align:center;
        ...
        <p>4.4. Другие значимые достижения в области научно-методической
                деятельности</p>
        <div class="table" style="margin-top: 25px;">
            <table style="border: 1px solid #000;
                              border-collapse: collapse;
