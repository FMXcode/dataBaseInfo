...
?>
<div class="container" style="background-color:  #6e8c45; padding: 100px 40px; margin-top: -70px;">
    <div class="wapper__block" style="background-color: #3b4c25;border-radius: 5px;width: 98%;margin: 0 auto; padding: 20px;">
        <div class="wapper_port" style="background-color: white; width: 800px;border-radius: 10px; margin: 0 auto; padding: 10px">
